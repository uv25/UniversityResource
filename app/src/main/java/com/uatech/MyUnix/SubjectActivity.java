...
public class SubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#6AA3BB")));
        ...
        userList.setAdapter(new MyAdapter(SubjectActivity.this, BluePrint.currentNode.child));
...
//        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_menu_black_24dp);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    Intent intent = new Intent(SubjectActivity.this, ContactUsActivity.class);
                    startActivity(intent);
                }
