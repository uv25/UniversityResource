...
public class SemesterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userList.setAdapter(new MyAdapter(SemesterActivity.this, BluePrint.currentNode.child));
...
//        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_menu_black_24dp);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    Intent intent = new Intent(SemesterActivity.this, AboutUsActivity.class);
                    startActivity(intent);
                }
                else if (id == R.id.nav_item_2)
                {
                    Intent intent = new Intent(SemesterActivity.this, ContactUsActivity.class);
                    startActivity(intent);
                }
